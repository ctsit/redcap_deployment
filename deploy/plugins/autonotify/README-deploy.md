...
post-deploy.sh creates a folder /etc/apache2/ssl-includes/ and adds a directive in the apache ssl site file to include all *.conf files in /etc/apache2/ssl-includes/.  Place the autonotify.conf for your environment in /etc/apache2/ssl-includes/ and restart apache to test the new directives.
